(function (global) {
  ...
  const READ_ACTIONS = new Set([
    'warmStaffLogin','getJobs','getPublicContents','getHumanVerificationChallenge','getApplicationStatus','getApplicationProfileImage','getLegacyApplicantByIdCard',
  ...
  const STATUS_SAFE_RETRY_ACTIONS = new Set(['getApplicationStatus']);
  ...
  const READ_CACHE_TTL_MS = Object.freeze({
    ...
    getHumanVerificationChallenge: 0,
