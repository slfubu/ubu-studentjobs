  ...
  async function invokeAppsScript(action, args) {
    ...
    try {
      ...
      if (error instanceof TypeError) {
        throw new Error(
          'เบราว์เซอร์เชื่อมต่อ Apps Script Web App ไม่ได้ (network/CORS/redirect) กรุณาตรวจสอบว่า Deployment มี doPost(e), URL เป็น /exec ของเวอร์ชันปัจจุบัน และ Who has access = Anyone'
        );
      }
