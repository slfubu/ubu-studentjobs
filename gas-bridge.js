  ...
  async function invokeAppsScriptOnce(action, args) {
    ...
    try {
      ...
      if (error instanceof TypeError) {
        throw new Error(
          'ไม่สามารถเชื่อมต่อ Apps Script Web App ได้ในขณะนี้ ระบบลองเชื่อมต่อซ้ำแล้ว กรุณาตรวจสอบอินเทอร์เน็ต และหากยังเกิดซ้ำให้ตรวจ Deployment: doPost(e), URL /exec ปัจจุบัน และ Who has access = Anyone'
        );
      }
