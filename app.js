const categoryConfig = {
    ...
    const PUBLIC_CONTENT_LOCAL_CACHE_PREFIX = 'UBU_PUBLIC_CONTENT_FAST_V2_';
    ...
    function openHomepageNewsItem(id, options = {}) {
      ...
      date.innerHTML = `<i class="fa-regular fa-calendar me-1"></i>วันที่ประกาศ ${escapeHtml(item.publishDate || '-')}${item.important ? ' <span class="homepage-news-important ms-2"><i class="fa-solid fa-star me-1"></i>ข่าวสำคัญ</span>' : ''}`;
