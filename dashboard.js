      const BUILD_VERSION = '2026.09.02-R4';
    ...
    async function renderStaffAccounts() {
      ...
      content.innerHTML = `
        <div class="d-flex flex-wrap justify-content-between gap-3 align-items-end mb-4">
          <div><div class="page-title">ลงทะเบียนผู้ใช้งานเจ้าหน้าที่</div><div class="page-subtitle">กำหนดชื่อผู้ใช้ สิทธิ์ หน่วยงาน และหน่วยคัดเลือกสำหรับการเข้าใช้งานระบบ</div></div>
          <div class="text-muted small"><i class="fa-solid fa-users-gear me-1"></i>บัญชีทั้งหมด <strong>${state.staffAccountRows.length.toLocaleString('th-TH')}</strong></div>
        </div>
